...
describe('Shapes', () => {
    ...
    describe('Triangle', () => {
        ...
        it('Should return a string for an svg with the given text and text color', () => {
            ...
            expect(textColor.textSvg()).toEqual(`<text x='150' y='150' font-size='50' text-anchor='middle' fill='white'>MMC</text>`);
        });
    });
});
...
describe('Shapes', () => {
    ...
    describe('Square', () => {
        ...
        it('Should return a string for an svg with the given text and text color', () => {
            ...
            expect(textColor.textSvg()).toEqual(`<text x='42%' y='50%' font-size='60' text-anchor='middle' fill='white'>MMC</text>`);
        });
    });
});
...
describe('Shapes', () => {
    ...
    describe('Circle', () => {
        ...
        it('Should return a string for an svg with the given text and text color', () => {
            ...
            expect(textColor.textSvg()).toEqual(`<text x='150' y='125' font-size='60' text-anchor='middle' fill='white'>MMC</text>`);
        });
    });
});
